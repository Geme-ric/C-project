            ...
            // Display the name of the user and continue
                   ...
                   if(choice==1){
                           //My account
                            ...
                            cout<<"|"<<setw(10)<<userDatabase[user].name<<" your current balace is  "<<setw(10)<<userDatabase[user].balance<<"               |"<<endl;;
                            cout<<"|  1. Back                                                   |" <<endl;
                           ...
                           cin>>str_choice;
                            ...
                            if (usernameExists(userDatabase, str_choice)) {
                                  ...
                                  cout<<"+------------------------------------------------------------+" <<endl
                                      <<"|        * Transfer     *                                      |" <<endl
                                      <<"| completed!, your account user name \""<<setw(7)<<user<<"\"has been transfered "<<setw(10)<<amount <<" birr to "
                                      <<"\n| "<<setw(7)<<str_choice<<". your current balance is  "<<setw(10)<<userDatabase[user].balance<<"             |"<<endl
                                      <<"|  1. Back                                                   |" <<endl
                          ...
                          userDatabase[user].balance = newBalance;
                           ...
                           if (choice>newBalance){
                            cout<<"Your account have no sufficient birr to withdraw. \n your current balance is "<<newBalance;
